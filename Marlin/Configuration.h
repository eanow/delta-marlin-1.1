...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 53.38
  #define  DEFAULT_bedKi 3.53
  #define  DEFAULT_bedKd 202.01
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 301.63 // mm
  ...
  #define DELTA_RADIUS 152.32

  // height from z=0.00 to home position
  #define DELTA_HEIGHT 388.8 // get this value from auto calibrate - use G33 C-1 at 1st time calibration
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 574 }  // default steps per unit for Kossel (GT2, 20 tooth)
